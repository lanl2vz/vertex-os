...
and runs the M14-M87 substrate gate with the M14-M87 QEMU test matrix:

```sh
scripts/krust-release-gate.sh
```

See [docs/krust-milestones.md](docs/krust-milestones.md) for M0 through M87
