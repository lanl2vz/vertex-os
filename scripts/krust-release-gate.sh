...
KRUST_CASES=${KRUST_CASES:-"m14 manifest-cycle bad-cap readiness-timeout rollback store-state-services timer preemption user-fault restart manifest-v1 cap-lifecycle typed-arenas quotas m32 m33 m34 m35 m36 m37 m38 m40 m41 manifest-truncated manifest-bad-magic manifest-raw-compact manifest-unsupported-version manifest-oob-record manifest-missing-provider"}
...
require_doc_line README.md "M14-M41"
...
require_doc_line docs/krust-milestones.md "Current status: M14-M41"
...
require_doc_line kernel/krust/README.md "M26-M41 Substrate"
...
echo
echo "Krust release gate ok: clean-clone M14-M41 proof is repeatable."
