...
KRUST_CASES=${KRUST_CASES:-"m14 manifest-cycle bad-cap readiness-timeout rollback store-state-services timer preemption user-fault restart manifest-v1 cap-lifecycle typed-arenas quotas m32 m33 m34 m35 m36 m37 m38 m40 m41 m42 m42-driver-fault m43 m43-bad-superblock m44 m45 m46 m47 m47-corrupt-executable manifest-truncated manifest-bad-magic manifest-raw-compact manifest-unsupported-version manifest-oob-record manifest-missing-provider"}
...
require_doc_line README.md "M14-M47"
...
require_doc_line docs/krust-milestones.md "Current status: M14-M47"
...
require_doc_line kernel/krust/README.md "M26-M47 Substrate"
...
echo
echo "Krust release gate ok: clean-clone M14-M47 proof is repeatable."
