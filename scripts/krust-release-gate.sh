...
require_doc_line README.md "M14-M79"
...
require_doc_line kernel/krust/README.md "M14-M79"
...
echo
echo "Krust release gate ok: clean-clone M14-M79 substrate proof is repeatable."
