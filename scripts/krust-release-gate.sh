...
require_doc_line README.md "M14-M69"
...
require_doc_line docs/krust-milestones.md "Current status: M14-M69"
...
require_doc_line kernel/krust/README.md "M14-M69"
...
echo
echo "Krust release gate ok: clean-clone M14-M69 proof is repeatable."
