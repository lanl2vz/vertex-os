...
require_doc_line README.md "M14-M75"
...
require_doc_line docs/krust-milestones.md "M74-M75 VFS substrate work is now smoke-tested"
...
require_doc_line kernel/krust/README.md "M14-M75"
...
mkdir -p "$LOG_DIR"
release_profile="$LOG_DIR/m75-release-profile.txt"
...
cat "$release_profile"
grep -Fq "krustboot=Manifest v1 compact KRUSTBOOTM75 version 11" "$release_profile" || fail "release profile missing M75 KrustBoot identity"
...
echo
echo "Krust release gate ok: clean-clone M14-M75 substrate proof is repeatable."
