...
run_fmt_manifest() {
    manifest=$1
    display=${manifest#"$ROOT_DIR"/}
    step "cargo fmt --manifest-path $display -- --check"
    cargo fmt --manifest-path "$manifest" -- --check
}

run_krust_fmt() {
    manifest=$1
    run_fmt_manifest "$KRUST_DIR/$manifest"
}
...
for manifest in "$KRUST_USER_DIR"/*/Cargo.toml; do
    run_fmt_manifest "$manifest"
done
...
require_doc_line README.md "M90"
require_doc_line README.md "M91"
require_doc_line README.md "M93"
require_doc_line README.md "M94"
...
require_doc_line README.md "M87-5"
...
require_doc_line docs/krust-milestones.md "The strict compact payload is version 19"
...
require_doc_line docs/krust-milestones.md "done: scripts/krust-test.sh m84"
...
require_doc_line docs/krust-milestones.md "scripts/krust-test.sh m90"
require_doc_line docs/krust-milestones.md "scripts/krust-test.sh m91"
require_doc_line docs/krust-milestones.md "scripts/krust-test.sh m92"
require_doc_line docs/krust-milestones.md "scripts/krust-test.sh m93"
require_doc_line docs/krust-milestones.md "scripts/krust-test.sh m94"
...
require_doc_line docs/krust-milestones.md "## M87-4: Usable Operator Console"
require_doc_line docs/krust-milestones.md "## M87-5: Truthful Operator Console"
...
require_doc_line kernel/krust/README.md "M90"
require_doc_line kernel/krust/README.md "M91"
require_doc_line kernel/krust/README.md "M93"
require_doc_line kernel/krust/README.md "M94"
...
require_doc_line kernel/krust/README.md "M87-5"
...
require_absent kernel/krust/user/Cargo.toml
require_absent kernel/krust/user/console-shell/Cargo.toml
require_absent kernel/krust/user/generation-manager/Cargo.toml
require_absent targets/krust/user/hello/Cargo.toml
require_absent targets/krust/user/ipc/Cargo.toml
...
mkdir -p "$LOG_DIR"
release_profile="$LOG_DIR/m86-release-profile.txt"
...
cat "$release_profile"
grep -Fq "krustboot=Manifest v1 compact KRUSTBOOTM86 version 19" "$release_profile" || fail "release profile missing M86 KrustBoot identity"
...
echo
echo "Krust release gate ok: clean-clone M14-M88 plus M90-M93 substrate proof is repeatable."
