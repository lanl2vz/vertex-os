...
require_doc_line README.md "M14-M65"
...
require_doc_line docs/krust-milestones.md "Current status: M14-M65"
...
require_doc_line kernel/krust/README.md "M26-M65 Substrate"
...
echo
echo "Krust release gate ok: clean-clone M14-M65 proof is repeatable."
