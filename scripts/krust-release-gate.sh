...
KRUST_CASES=${KRUST_CASES:-"m14 manifest-cycle bad-cap readiness-timeout rollback store-state-services timer preemption user-fault restart manifest-v1 cap-lifecycle typed-arenas quotas m32 m33 m34 m35 m36 m37 m38 m40 m41 m42 m42-driver-fault m43 m43-bad-superblock m44 m45 m46 m47 m47-corrupt-executable m48 m49 m49-config-corrupt m50 m54 m55 m56 m57 m59 m60 m61 manifest-truncated manifest-bad-magic manifest-raw-compact manifest-old-compact-magic manifest-unsupported-version manifest-oob-record manifest-missing-provider"}
...
require_doc_line README.md "M14-M61"
...
require_doc_line docs/krust-milestones.md "Current status: M14-M61"
...
require_doc_line kernel/krust/README.md "M26-M61 Substrate"
...
echo
echo "Krust release gate ok: clean-clone M14-M61 proof is repeatable."
