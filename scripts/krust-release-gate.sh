...
KRUST_CASES=${KRUST_CASES:-"m14 manifest-cycle bad-cap readiness-timeout rollback store-state-services timer preemption user-fault restart manifest-v1 cap-lifecycle typed-arenas quotas m32 m33 m34 m35 m36 m37 manifest-truncated manifest-bad-magic manifest-raw-compact manifest-unsupported-version manifest-oob-record manifest-missing-provider"}
...
require_doc_line README.md "M14-M37"
require_doc_line README.md "scripts/krust-release-gate.sh"
require_doc_line docs/krust-milestones.md "Current status: M14-M37"
...
require_doc_line docs/krust-abi-v0.md "M37 upgrades generation activation"
require_doc_line kernel/krust/README.md "M26-M37 Substrate"
...
echo
echo "Krust release gate ok: clean-clone M14-M37 proof is repeatable."
