...
require_doc_line README.md "M14-M73"
...
require_doc_line docs/krust-milestones.md "Current status: M14-M73"
...
require_doc_line kernel/krust/README.md "M14-M73"
...
mkdir -p "$LOG_DIR"
release_profile="$LOG_DIR/m65-release-profile.txt"
...
cat "$release_profile"
grep -Fq "krustboot=Manifest v1 compact KRUSTBOOTM65 version 8" "$release_profile" || fail "release profile missing M65 KrustBoot identity"
...
echo
echo "Krust release gate ok: clean-clone M14-M73 proof is repeatable."
